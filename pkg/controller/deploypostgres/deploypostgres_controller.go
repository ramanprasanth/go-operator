...
/*
	//This code is for creating a Pod without deployment
	// Define a new Pod object
	pod := newPodForCR(instance)

	// Set DeployPostgres instance as the owner and controller
	...
	if err != nil && errors.IsNotFound(err) {
		reqLogger.Info("Creating a new Pod", "Size",instance.Spec.Size,"PVC name",instance.Spec.PersistentVolumeClaim.Name,"Pod.Namespace", pod.Namespace, "Pod.Name", pod.Name)
...
/*
// newPodForCR returns a postgres pod with the same name/namespace as the cr
func newPodForCR(cr *postgresv1alpha1.DeployPostgres) *corev1.Pod {
	...
	return &corev1.Pod{
		...
		Spec: corev1.PodSpec{
			...
			ConfigMapKeyRef: &corev1.ConfigMapKeySelector{LocalObjectReference: corev1.LocalObjectReference{Name: "cm"}, Key: "POSTGRES_PASSWORD"}},},
			...
			//Volumes: []corev1.Volume{{Name: "postgres-data", VolumeSource: corev1.VolumeSource{EmptyDir: &corev1.EmptyDirVolumeSource{}}}},
			Volumes: []corev1.Volume{{Name: "postgres-data", VolumeSource: corev1.VolumeSource{PersistentVolumeClaim: &corev1.PersistentVolumeClaimVolumeSource{ClaimName:   cr.Spec.PersistentVolumeClaim.Name,},	},}},
		},
	}
}*/
// reconcilePVC ensures the Persistent Volume Claim is created.
func (r *ReconcileDeployPostgres) reconcilePVC(cr *postgresv1alpha1.DeployPostgres) error {
...
func newPVCs(cr *postgresv1alpha1.DeployPostgres) *corev1.PersistentVolumeClaim {
	labels := map[string]string{
		"app": cr.Name,
	}
...
func (r *ReconcileDeployPostgres) deploymentForPostgres(m *postgresv1alpha1.DeployPostgres) *appsv1.Deployment {
	...
	dep := &appsv1.Deployment{
		...
		Spec: appsv1.DeploymentSpec{
			...
			Volumes: []corev1.Volume{{Name: "postgres-data", VolumeSource: corev1.VolumeSource{PersistentVolumeClaim: &corev1.PersistentVolumeClaimVolumeSource{ClaimName:   m.Spec.PersistentVolumeClaim.Name,},	},}},
